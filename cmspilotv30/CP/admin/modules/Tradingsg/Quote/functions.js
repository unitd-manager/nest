...
cpm.tradingsg.quote = {
    init: function(){
        ...
        $('.row-tradingsg_quote__tradingsg_productLink .discount-type').livequery('change', function(){
            ...
            var discount_percentage = discountValObj.val();
                 var sellingPriceObj = $(this).parents('tr').find('input[name=selling_price_amount]');
        var sellingPrice    = sellingPriceObj.val();
            ...
            $.get(url, {rec_id: rec_id, discount_type: discount_type, discount_percentage: discount_percentage,sellingPrice: sellingPrice}, function(json){
                totalSellingPriceObj.html(json.totalSellingPrice);
        ...
        var sellingPrice    = sellingPriceObj.val();
            ...
            $.get(url, {rec_id: rec_id, mark_up_type: mark_up_type, mark_up: mark_up,sellingPrice: sellingPrice}, function(json){
                totalSellingPriceObj.html(json.totalSellingPrice);
                costPriceObj.html(json.totalCostPrice);
    ...
    quoteProductMarkUp: function(e) {
        ...
        $.get(url, {rec_id: rec_id, mark_up: mark_up, discount_percentage: discount_percentage,sellingPrice:sellingPrice}, function(json){
            totalSellingPriceObj.html(json.totalSellingPrice);
