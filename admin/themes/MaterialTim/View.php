<?
class CPL_Admin_Themes_MaterialTim_View extends CP_Admin_Lib_ThemeViewAbstract
{
        ...
        <div class='floatbox'>
            <div class='col-md-12 noPadding'>
                <table class='table loginLeftPanelTableLogo'>
                    ...
                    <tr>
                        <td class='loginTitle txtCenter' colspan='2'><h1>NEST 'N' NOOK FURNISHINGS - CRM</h1></td>
                    </tr>
                </table>
            </div>
        </div>
