  ...
  $quote_date = $fn->getCPDate($Row['quote_date'], 'd-m-Y');
        ...
        $tbl11 = '
				...
				<img src="images/logo-print.png" width="" height=""/>
                    ...
                    <td width="90%" align="right">QN : '.$quoteCode.'<br/> '.$quote_date.'</td>
            ...
            <table border="0" cellpadding="6"  width="100%" style="background-color: #33ccff; color: #FFFFFF;">
                  <tr>
                    <td style="font-size: 20px; font-weight: bold;">Job Quotation</td>
                  </tr>
            ...
            $tbl2 = '
            <table border="0" width="100%" style="font-size:14px; font-weight:bold;">
                <tr>
            ...
            ';
                ...
                $tbl3 = '
                <table width="100%" style="font-size:14px;border-spacing: 10px;">
                    <thead>
                        <tr>
                            <td width="10%" style="background-color: #33ccff; color: #FFFFFF;">S.NO</td>
                            <td align="center"  width="45%" style="background-color: #F0F8FF; color: #000;">NAME OF THE ITEM</td>
                            <td align="center"  width="10%" style="background-color: #F0F8FF; color: #000;">QTY</td>
                            <td align="center"  width="17%" style="background-color: #F0F8FF; color: #000;">UNIT PRICE</td>
                            <td align="center"  width="18%" style="background-color: #F0F8FF; color: #000;">TOTAL ('.$Row['currency'].')</td>
                        </tr>
                    </thead>
                    <tbody>
                ';
            ...
            while($row = $db->sql_fetchrow($result)){
                ...
                $discount_value_for_one_qty = number_format($discount_value_for_one_qty, 2);
                    ...
                    $tbl3 = $tbl3.'<tr>
                                        <td  width="10%" style="background-color: #33ccff; color: #FFFFFF;font-weight:normal;">'.$count.'</td>
                                        <td align="left"  width="45%" style="background-color: #F0F8FF; color: #000;font-weight:normal;">'.$titledescrip.'</td>
                                        <td align="center" width="10%" style="background-color: #F0F8FF; color: #000;font-weight:normal;">'.$row['qty'].'</td>
                                        <td align="right" width="17%" style="background-color: #F0F8FF; color: #000;font-weight:normal;">'.$selling_price.'</td>
                                        <td align="right" width="18%" style="background-color: #F0F8FF; color: #000;font-weight:normal;">'.$tsp.'</td>
                                    </tr>
                                   ';
            ...
            $tbl3 = $tbl3.'<tr>
                        <td colspan="4" align="right" style="font-weight:bold;"><strong>Subtotal:</strong></td>
                        <td align="right">'.$sub_total.'</td>
                    </tr>
                    <tr>
                     <td colspan="4" align="right" style="font-weight:bold;"><strong>Discount:</strong></td>
                        <td align="right">'.$discount.'</td>
                    </tr>
                    <tr>
                     <td colspan="4" align="right" style="font-weight:bold;"><strong>Tax:</strong></td>
                    ...
                    <tr>
                     ...
                     <tr>
                           ...
                           <td ></td>
                           <td ></td>
                          <td colspan="4"  align="right" style="font-weight:bold;background-color: #ddd;"><strong>Total Estimate:</strong>   '.$totaldiscount.'</td>
                    </tr>
                    </tbody></table>';
            ...
            $tbl7 = '
            <table border="0" width="100%" align="right" style="font-size:14px;">
                <tr>
