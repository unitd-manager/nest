...
class CPL_Admin_Modules_Tradingsg_PurchaseOrder_Model extends CP_Common_Lib_ModuleModelAbstract
{
    ...
    function getAddNewProductSubmit() {
        ...
        for ($i= 0; $i < $count; $i++) {
            ...
            if ($cpCfg['cp.serialKeyActive'] == "SULB-DHEO-0R6K-59CL" || $cpCfg['cp.serialKeyActive'] == "YODX0-9DT58-VCZ5W-A8XXB") {
                $product_code = $product_code_arr[$i];
            }
    ...
    function getImportData(){
        ...
        $fa = array(
             ...
             ,'mrp'       => $phpExcel->getImportFldObj('Mrp')
   ...
   /**
     ...
     *
     */
    function importDataRowCallbackBackUP($purchase_order_id, $fa) {
        $cpCfg = Zend_Registry::get('cpCfg');
        $fn = Zend_Registry::get('fn');
        $dbUtil = Zend_Registry::get('dbUtil');
        $db = Zend_Registry::get('db');
