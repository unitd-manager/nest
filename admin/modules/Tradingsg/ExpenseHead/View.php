<?
class CPL_Admin_Modules_Tradingsg_ExpenseHead_View extends CP_Common_Lib_ModuleViewAbstract
{
   function getList($dataArray){
    ...
    function getRightPanel($row){
        ...
        {$comment->getView(array(
             'roomName' => 'tradingsg_expenseHead'
            ,'recordId' => $record_id
        ))}
        ";
    ...
    function getExpenseSubHeadDetail($expense_group_id=''){
        ...
        $formActionExpenseSubHead = "index.php?module=tradingsg_expenseHead&_spAction=AddExpenseSubHead&expense_group_id={$expense_group_id}&showHTML=0";
        ...
        $text = "
        <div class='linkPortalWrapper tradingsg_expenseHead_expenseSubHeadLink'>
    ...
    function getExpenseSubHeadDetailList($expense_group_id = ''){
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            $formActionEditExpenseSubHead   = "index.php?module=tradingsg_expenseHead&_spAction=EditExpenseSubHead&expense_sub_group_id={$row['expense_sub_group_id']}&expense_group_id={$expense_group_id}&showHTML=0";
    ...
    function getAddExpenseSubHead() {
        ...
        $formAction = "index.php?_topRm=main&module=tradingsg_expenseHead&_spAction=expenseSubHeadFormSubmit&showHTML=0";
    ...
    function getEditExpenseSubHead() {
        ...
        $formAction = "index.php?module=tradingsg_expenseHead&_spAction=EditExpenseSubHeadFormSubmit&showHTML=0&expense_sub_group_id={$expense_sub_group_id}";
