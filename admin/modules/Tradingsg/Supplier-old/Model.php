<?
class CPL_Admin_Modules_Tradingsg_Supplier_Model extends CP_Admin_Modules_Tradingsg_Supplier_Model
{
    /**
     *
     */
    ...
    function setSearchVar($linkRecType = '') {
        ...
        if ($supplier_id != "") {
            ...
            $fn->setSearchVarForLinkData($searchVar, $linkRecType, 'c.supplier_id');
    ...
    function getFields(){
        ...
        $fa = $fn->addToFieldsArray($fa, 'add_vat');
        $fa = $fn->addToFieldsArray($fa, 'add_cst');
        $fa = $fn->addToFieldsArray($fa, 'add_pf');
        $fa = $fn->addToFieldsArray($fa, 'add_freight_cost');
        $fa = $fn->addToFieldsArray($fa, 'vat');
        $fa = $fn->addToFieldsArray($fa, 'cst');
        $fa = $fn->addToFieldsArray($fa, 'p_f');
    ...
    function getTradingsgSupplierTradingsgContactLinkSQL($id) {
        ...
        WHERE a.company_id = b.supplier_id
