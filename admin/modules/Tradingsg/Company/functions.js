    ...
    init: function(){
        ...
        /*$('.AddProductKeyLinkButton').livequery('click', function (e){
            ...
            if (confirm(msg)){
                ...
                var url = "index.php?module=tradingsg_company&_spAction=linkProductKeyForCompany&company_id=" + company_id + "&showHTML=0";
                $.get(url, function(){
                    reloadCompanyList.reloadProductKeyLink(company_id);
                });
            }
...
var reloadCompanyList ={
    ...
    reloadProductKeyLink: function(company_id){
        var url = 'index.php?module=tradingsg_company&_spAction=ProductKeyPortal&showHTML=0';
        $.get(url, {company_id: company_id}, function(html){
            Util.hideProgressInd();
