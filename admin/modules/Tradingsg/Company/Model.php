<?
class CPL_Admin_Modules_Tradingsg_Company_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    ...
    function getFields(){
        ...
        $fa = $fn->addToFieldsArray($fa, 'loyalty_point_linked');
        $fa = $fn->addToFieldsArray($fa, 'loyalty_linked_date');
