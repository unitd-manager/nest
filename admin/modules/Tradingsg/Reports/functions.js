...
cpm.tradingsg.reports = {
    init: function(){
        ...
        $('.purchaseOrderVal').livequery('click', function(){
            var parent = $(this).closest('.supplierPaymentReport');
            $('.purchaseOrderDetails', parent).slideToggle();
        });

        $('.InvoiceRecDetailsToggle').livequery('click', function(){
            var parent = $(this).closest('.detailSummaryByClientPaymentDetails');
            $('.InvoiceReceiptDetails', parent).slideToggle();
        });

        $('.w-tradingsg-detailCollectionReport .OrderItemDetailsToggle').livequery('click', function(){
            var parent = $(this).closest('.detailCollectionOrderItemDetails');
            $('.OrderItemDetails', parent).slideToggle();
        });
    },
