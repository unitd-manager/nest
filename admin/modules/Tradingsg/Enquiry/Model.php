<?
class CPL_Admin_Modules_Tradingsg_Enquiry_Model extends CP_Admin_Modules_Tradingsg_Enquiry_Model
{
    function getSQL() {
        ...
        if ($_SESSION['userGroupType'] == "User") {
            $extraTableNames .= "enquiry_product_group epg_hist, product_group_staff pgs_hist,";
            $joinFlds .= "
        ...
        SELECT DISTINCT e.enquiry_id
              ...
              ,CONCAT_WS(' ', st.first_name, st.last_name ) AS staff_name_assigned
    ...
    function setSearchVar() {
        ...
        if ($enquiry_id != "") {
            ...
            if ($_SESSION['userGroupType'] == "User") {
				...
				$searchVar->sqlSearchVar[] = "pgs_hist.staff_id = '{$_SESSION['staff_id']}'";
                $searchVar->sqlSearchVar[] = "epg_hist.product_group_id  = pgs_hist.product_group_id";
                */
                $searchVar->sqlSearchVar[] = "(e.enquiry_id = epg_hist.enquiry_id
        ...
        $searchVar->sortOrder = "e.enquiry_id DESC";
    }
    ...
    function getAdd(){
        ...
        if ($_SESSION['userGroupType'] == "User") {
            $fa['staff_allocation']   = $_SESSION['staff_id'];
        }
        $id = $fn->addRecord($fa);
