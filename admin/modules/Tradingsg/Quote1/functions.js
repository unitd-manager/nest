...
$(function(){
    ...
    $("a.addRow").livequery('click', function (e){
        var url = 'index.php?module=tradingsg_quote&_spAction=addProductRecord'
                + '&showHTML=0';
    ...
    $(".removeProduct").livequery('click', function (e){
        $(this).closest('tr').remove();
    });

    $(".saveRecord").livequery('click', function (e){
        $(this).closest('saveRecord').hide();
    });
