<?
class CPL_Admin_Widgets_Tradingsg_QuoteByStaff_Model extends CP_Admin_Widgets_Tradingsg_QuoteByStaff_Model
{
    /**
     *
     */
    ...
    function getExportToExcel(){
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $quote_amount);
