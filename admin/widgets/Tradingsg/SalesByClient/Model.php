<?
class CPL_Admin_Widgets_Tradingsg_SalesByClient_Model extends CP_Admin_Widgets_Tradingsg_SalesByClient_Model
{
    /**
     *
     */
    ...
    function setSearchVar() {
        ...
        if($sortOrder == 0){
            ...
            $searchVar->sortOrder = 'company_name DESC';
        }
    ...
    function getExportToExcel(){
        ...
        $orderByCondition = '';
        if($sortOrder == 0){
            $orderByCondition = 'ORDER BY company_name ASC';
        }else{
            $orderByCondition = 'ORDER BY company_name DESC';
        }
