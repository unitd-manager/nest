<?
class CPL_Admin_Widgets_Tradingsg_EnquiryByMonthChart_View extends CP_Admin_Widgets_Tradingsg_EnquiryByMonthChart_View
{
    /**
     *
     */
    function getWidget() {
        ...
        <script type='text/javascript' src='https://www.google.com/jsapi'></script>
            <script type='text/javascript'>
                ...
                chart.draw(data, {colors: ['#FF00FF'], width: 600, height: 340, title: '',
