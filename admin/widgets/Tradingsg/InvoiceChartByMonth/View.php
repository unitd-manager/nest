<?
class CPL_Admin_Widgets_Tradingsg_InvoiceChartByMonth_View extends CP_Admin_Widgets_Tradingsg_InvoiceChartByMonth_View
{
    /**
     *
     */
    function getWidget() {
        ...
        <script type='text/javascript' src='https://www.google.com/jsapi'></script>
            <script type='text/javascript'>
                ...
                chart.draw(data, {colors: ['#8A2BE2'], width: 600, height: 340, title: '',
